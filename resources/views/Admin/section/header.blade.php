<div class="app-header header sticky">
    <div class="container-fluid main-container">
        <div class="d-flex">
            ...
            <a class="logo-horizontal " href="index-2.html">
                <img src="../assets/images/brand/logo.png" class="header-brand-img desktop-logo" alt="logo">
                <img src="../assets/images/brand/logo-3.png" class="header-brand-img light-logo1" alt="logo">
            </a>

            <div class="main-header-center ms-3 d-none d-lg-block">
                <input type="text" class="form-control" id="typehead" placeholder="جستجو برای نتایج ..."
                       autocomplete="off">
...
348 هزار تومان
                                        ...
                                        <div class="dropdown-item d-flex p-4">
                                            ...
                                            <div class="wd-50p">
                                                ...
                                                <span>وضعیت: <span
                                                        class="text-danger">اتمام موجودی</span></span>
...
867 هزار تومان
                                        ...
                                        <div class="dropdown-item d-flex p-4">
                                            ...
                                            <div class="wd-50p">
                                                ...
                                                <span>وضعیت: <span
                                                        class="text-success">موجود در انبار</span></span>
...
456 هزار تومان
                                    ...
                                    <div class="dropdown-footer">
                                        <a class="btn btn-primary btn-pill w-sm btn-sm py-2"
                                           href="checkout.html"><i class="fe fe-check-circle"></i> تسویه
                                            حساب</a>
                                ...
                                <div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                                    ...
                                    <div class="notifications-menu">
                                        ...
                                        <a class="dropdown-item d-flex" href="notify-list.html">
                                            ...
                                            <div class="mt-1 wd-80p">
                                                <h5 class="notification-label mb-1">پروژه شما تایید شده
                                                    است.</h5>
                                    ...
                                    <div class="dropdown-divider m-0"></div>
                                    <a href="notify-list.html" class="dropdown-item text-center p-3 text-muted">مشاهده
                                        همه
                                        اعلان</a>
                                </div>
                            </div>
                            ...
                            <div class="dropdown  d-flex message">
                                ...
                                <div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                                    <div class="drop-heading border-bottom">
                                        <div class="d-flex">
                                            <h6 class="mt-1 mb-0 fs-16 fw-semibold text-dark">شما 5 پیام
                                                دارید</h6>
                                            <div class="ms-auto">
                                                <a href="javascript:void(0)" class="text-muted p-0 fs-12">علامت
                                                    به عنوان خوانده شده</a>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="message-menu message-menu-scroll">
                                        <a class="dropdown-item d-flex" href="chat.html">
                                            ...
                                            <div class="wd-90p">
                                                ...
                                                <span>در مورد فایل فهرست مهمان نظر داد....</span>
                                            </div>
                                        </a>
                                        <a class="dropdown-item d-flex" href="chat.html">
                                                    <span class="avatar avatar-md brround me-3 align-self-center cover-image"
                                    ...
                                    <a href="javascript:void(0)"
                                       class="dropdown-item text-center p-3 text-muted">نمایش همه پیام ها</a>
                                </div>
                            </div>
                                ...
                                <div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                                    <div class="drop-heading">
                                        <div class="text-center">
                                            <h5 class="text-dark mb-0 fs-14 fw-semibold">پرسی کیوشون</h5>
                                            <small class="text-muted">سرپرست ارشد</small>
                                        </div>
                                    </div>
                                    <div class="dropdown-divider m-0"></div>
