    ...
    var handleForms = function () {
        $(document).on("submit", ".ajaxSubmit", function (event) {
            ...
            var form = $(this),
                ...
                feedback = (typeof form.data('feedback') !== 'undefined' && form.data('feedback') !== "") ? form.data('feedback') : 'alertBox',
            ...
            $('.form_msg_validate').addClass('m--hide');
            $.ajaxSetup({
                headers: {
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if (fadeOut > 0)
                        $("#" + feedback).find('.m-alert').fadeOut(parseInt(fadeOut));
