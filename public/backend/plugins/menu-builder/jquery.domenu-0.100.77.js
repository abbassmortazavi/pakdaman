...
(function ($, window, document, undefined) {
  ...
  var defaults = {
    ...
    advanceEditFunction  :  'advanceEdit', //edit icon function
    advanceGroupFunction  : 'advanceGroup' //select checked and add group
  };
  ...
  Plugin.prototype = {
    ...
    createNewListItem:                function (data) {
      ...
      blueprint.remove = function () {
        ...
        blueprint.find(".item-edited").click(function () {
            var fnName=opt.advanceEditFunction;
            var param=blueprint.data("id");
            window[fnName](param);
        });

        blueprint.find(".item-grouped").click(function () {
            var fnName=opt.advanceGroupFunction;
            var param=blueprint.data("id");
            if(this.checked){
                window[fnName](param,'checked');
            }
            else{
                window[fnName](param,'unchecked');
            }
        });
