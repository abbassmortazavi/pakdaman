...
(function($, undefined) {
	...
	$.extend(Datepicker.prototype, {
		...
		_optionDatepicker : function(e, t, n) {
			...
			if (r) {
				...
				if (o !== null && i["dateFormat"] !== undefined && i["minDate"] === undefined)
					r.settings.minDate = this._formatDate(r, o);
				if (u !== null && i["dateFormat"] !== undefined && i["maxDate"] === undefined)
			...
			if ($.datepicker._datepickerShowing)
				switch(e.keyCode) {
					...
					case 13:
						...
						if (i[0])
							$.datepicker._selectDay(e.target, t.selectedMonth, t.selectedYear, i[0]);
		...
		_showDatepicker : function(e) {
			...
			if (!t.inline) {
				...
				if (!o || !u)
					a();
				if (t.input.is(":visible") && !t.input.is(":disabled"))
					t.input.focus();
		...
		_updateDatepicker : function(e) {
			...
			if (i > 1)
				e.dpDiv.addClass("ui-datepicker-multi-" + i).css("width", s * i + "em");
		...
		_hideDatepicker : function(e) {
			...
			if (this._datepickerShowing) {
				...
				if (s)
					s.apply(t.input ? t.input[0] : null, [t.input ? t.input.val() : "", t]);
		...
		_checkExternalClick : function(e) {
			...
			if (t[0].id != $.datepicker._mainDivId && t.parents("#" + $.datepicker._mainDivId).length == 0 && !t.hasClass($.datepicker.markerClassName) && !t.closest("." + $.datepicker._triggerClass).length && $.datepicker._datepickerShowing && !($.datepicker._inDialog && $.blockUI) || t.hasClass($.datepicker.markerClassName) && $.datepicker._curInst != n)
				$.datepicker._hideDatepicker()
		},
		...
		parseDate : function(e, t, n) {
			...
			if (a == -1)
				a = (new this.CDate).getFullYear();
			else if (a < 100)
				a += (new this.CDate).getFullYear() - (new this.CDate).getFullYear() % 100 + (a <= r ? 0 : -100);
			if (c > -1) {
				f = 1;
				l = c;
				do {
		...
		_compareDate : function(e, t, n) {
			if (e && n) {
				if (e.getGregorianDate)
					e = e.getGregorianDate();
				if (n.getGregorianDate)
					n = n.getGregorianDate();
				if (t == "<")
					return e < n;
				return e > n
			} else {
	...
	$.fn.datepicker = function(e) {
		...
		if ( typeof e == "string" && (e == "isDisabled" || e == "getDate" || e == "widget"))
			return $.datepicker["_" + e + "Datepicker"].apply($.datepicker, [this[0]].concat(t));
